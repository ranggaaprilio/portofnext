...
import { tool as hexadecimalEsacapeCharacter } from './hexadecimal-esacape-character';
import { tool as beautifulGrammer } from './beautiful-grammer';
import { tool as searchParamsDecode } from './search-params-decode';
...
export const toolsByCategory: ToolCategory[] = [
  ...
  {
    name: 'Text',
    components: [loremIpsumGenerator, textStatistics, emojiPicker, stringObfuscator, textDiff, beautifulGrammer],
  },
  {
    name: 'Data',
    components: [
